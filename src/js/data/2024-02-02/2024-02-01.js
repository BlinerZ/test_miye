dataSetVersion = "2024-02-01"; // Change this when creating a new data set version. YYYY-MM-DD format.
dataSet[dataSetVersion] = {};

dataSet[dataSetVersion].options = [
    {
        name: "Filter by op/ed/ins",
        key: "singer",
        tooltip: "Check to show",
        checked: true,
        sub: [
            {name: "Anime Openings", key: "OP", checked: true},
            {name: "Anime Endings", key: "ED", checked: true},
            {name: "Anime Insert", key: "INS", checked: true}
        ]
    }
];
